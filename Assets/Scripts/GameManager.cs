...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject BowlingPinCollection;
    ...
    private void SetPins()
    {
        ...
        pinObjects = Instantiate(BowlingPinCollection, pinAnchor.transform.position, Quaternion.identity, transform);
